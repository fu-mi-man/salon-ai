...
|---|---|---|---|---|---|
| 0-1 | ルート(`/`)を掃除し共通の枠（ヘッダー・レイアウト・トークン）を整える | ⬜ |  | なし | infra |
| 0-2 | ダッシュボードの静的UIを作る | ⬜ |  | 0-1 | enhancement |
| 0-3 | ログインの静的UIを作る | ⬜ |  | 0-1 | enhancement |
| 0-4 | パスワードリセットの静的UIを作る | ⬜ |  | 0-1 | enhancement |
| 0-5 | 画面間のリンク遷移をつなぐ | ⬜ |  | 0-2,0-3,0-4 | enhancement |
...
| No. | タイトル | 状態 | GH# | 前提 | ラベル |
|---|---|---|---|---|---|
| 1-1 | 入力まわりの操作（自動伸縮・生成ボタン非活性）を実装する | ⬜ |  | Step0 | enhancement |
| 1-2 | カードのコピー・削除操作を実装する | ⬜ |  | Step0 | enhancement |
| 1-3 | 編集モードと「AIで修正」UI（ダミー応答）を実装する | ⬜ |  | 1-2 | enhancement |
| 1-4 | 履歴のページネーション（もっと見る）を実装する | ⬜ |  | Step0 | enhancement |
...
| No. | タイトル | 状態 | GH# | 前提 | ラベル |
|---|---|---|---|---|---|
| 4-1 | 履歴一覧をServer ComponentでDBから取得する | ⬜ |  | Step2 | enhancement |
| 4-2 | カード削除をServer Action化する | ⬜ |  | 4-1 | enhancement |
| 4-3 | 編集保存をServer Action化する | ⬜ |  | 4-1 | enhancement |
| 4-4 | pg_cronとトリガで30日後の自動削除を設定する | ⬜ |  | 4-1 | infra |
...
| No. | タイトル | 状態 | GH# | 前提 | ラベル |
|---|---|---|---|---|---|
| 6-1 | AI修正用Server Actionを実装する | ⬜ |  | 5-2 | enhancement |
| 6-2 | 編集モードのダミーUIをAI修正Server Actionに接続する | ⬜ |  | 6-1,1-3 | enhancement |
...
| No. | タイトル | 状態 | GH# | 前提 | ラベル |
|---|---|---|---|---|---|
| 7-1 | 初期アカウント発行手順をドキュメント化する | ⬜ |  | Step3,Step5 | docs |
